...
var RCTModule = NativeModules.BG5LModule
...
module.exports = {
    /**
     * Notify event type for BG5L.
     */
    Event_Notify: RCTModule.Event_Notify,

    /**
     * keep BG5L connecting.
     * <ul>
    ...
    holdLink: function (mac){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L holdLink RCTModule is null')
        }
    },
    ...
    getBattery: function (mac){
        ...
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L getBattery RCTModule is null')
        }
    },
    ...
    setTime: function (mac){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L setTime RCTModule is null')
        }
    },
    ...
    setUnit: function (mac, type){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L setUnit RCTModule is null')
        }
    },
    ...
    startMeasure: function (mac, type){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L startMeasure RCTModule is null')
        }
    },
    ...
    getOfflineData: function (mac){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L getOffineData RCTModule is null')
        }
    },
    ...
    deleteOfflineData: function (mac){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L deleteOfflineData RCTModule is null')
        }
    },
    ...
    getBottleMessage: function (mac){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L getBottleMessage RCTModule is null')
        }
    },
    ...
    setBottleID: function (mac, ID){
        if (RCTModule != null) {
            ...
            console.log('~~~~~ BG5L setBottleID RCTModule is null')
        }
    },
