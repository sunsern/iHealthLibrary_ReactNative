 ...
 * @param armWaveletWithHeartbeat  Return Wavelet value of upper-arm BPM, with heartbeats.
 * @param legWaveletWithHeartbeat  Return Wavelet value of ankle BPM, with heartbeats.
 * @param armWaveletWithoutHeartbeat  Return Wavelet value of upper-arm BPM, without heartbeats.
 * @param legWaveletWithoutHeartbeat  Return Wavelet value of ankle BPM, without heartbeats.
 ...
 */
-(void)stopABIMeassureErrorBlock:(BlockSuccess)success errorBlock:(BlockError)error;
 ...
 * @param blockZeroState Zeroing state
 * @param armPressure  Return Upper-arm blood pressure value during measurement, unit as mmHg.
 * @param armWaveletWithHeartbeat  The Wavelet value of upper-arm BPM, with heartbeats.
 * @param armWaveletWithoutHeartbeat  The Wavelet value of upper-arm BPM, without heartbeats.
 ...
 * @param error A block to return the error in ‘Establish measurement connection' in ABI.
 */
-(void)stopABIArmMeassureBlock:(BlockResult)result errorBlock:(BlockError)error;
